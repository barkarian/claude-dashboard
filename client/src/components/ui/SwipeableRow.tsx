...
export default function SwipeableRow({ onDelete, children, className }: SwipeableRowProps) {
  ...
  return (
    <div className={`relative overflow-hidden ${className || ''}`}>
      {/* Delete zone behind */}
      {offsetX < 0 && (
        <div className="absolute inset-y-0 right-0 flex items-center justify-center bg-danger text-white text-sm font-medium"
