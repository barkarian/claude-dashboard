    ...
    variants: {
      variant: {
        ...
        primary:
          "bg-primary text-white shadow hover:bg-primary-hover",
        outline:
          "border border-border bg-transparent shadow-sm hover:bg-bg-hover hover:text-text",
        secondary:
          "bg-bg-surface text-text shadow-sm hover:bg-bg-hover",
        ghost: "hover:bg-bg-hover hover:text-text",
