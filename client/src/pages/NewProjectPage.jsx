...
import RepoSelector from '../components/projects/RepoSelector.jsx';
import SetupTerminal from '../components/projects/SetupTerminal.jsx';
...
export default function NewProjectPage() {
  ...
  function handleCustomUrl() {
    ...
    setSelectedRepo({ name, url: customUrl.trim() });
    setProjectName(name);
    setStep(2);
  }
  ...
  async function handleCreate() {
    ...
    try {
      ...
      const data = await api.post('/api/projects', { name: projectName, repoUrl });
